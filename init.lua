...
require('lazy').setup({
  ...
  },--]===]
  {
    ...
    config = function()
      vim.keymap.set('n', '<leader>z', ':ZenMode<CR>', { desc = 'Turn on ZenMode' })
    end,
    plugins = {
      kitty = {
        enabled = false,
  ...
  --[==[{
    ...
    config = function()
      ...
      dashboard.section.header.val = neovimTitle 
      dashboard.section.footer.val = frog 
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'javascript', 'typescript', 'go' },
